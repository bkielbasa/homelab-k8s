...
*/}}
{{- define "darek.labels" -}}
helm.sh/chart: {{ include "darek.chart" . }}
{{ include "darek.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels.
*/}}
{{- define "darek.selectorLabels" -}}
app.kubernetes.io/name: {{ include "darek.name" . }}
